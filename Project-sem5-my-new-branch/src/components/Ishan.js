...
{/* 
               ...
               */}
                    ...
                    <textarea   className='pui'     id="msg" name="msg" rows="4" cols="10" required></textarea>
                    <div>
...
<div className="modal-wrapper" onClick={handleModelSubmit}></div>
         <div className="modal-container">
            ...
            <div className='buttonm'>
              ...
              <button   className='modal-btn'  onClick={handleModelSubmit} >Cancel</button>
              </div> 
